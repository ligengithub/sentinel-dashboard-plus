...
//    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
    public Result<HashMap<String,Object>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            List<GatewayFlowRuleEntity> flowRules = gatewayFlowProvider.getRules(app);
